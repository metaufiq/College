...
public class empatKetujuh : MonoBehaviour {
	...
	void Update () {
		if ((satuKeduaScript.Graf [3, 6] != 0 || satuKeduaScript.Graf [3, 6] != 0)&& kameraScript.menuButtonPlay!="give up?") {

			satuKeduaText.text =" " + satuKeduaScript.Graf [3, 6];
