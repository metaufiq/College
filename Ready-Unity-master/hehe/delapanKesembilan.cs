...
public class delapanKesembilan : MonoBehaviour {
	...
	void Update () {
		if ((satuKeduaScript.Graf [7, 8] != 0 || satuKeduaScript.Graf [7, 8] != 0) && kameraScript.menuButtonPlay!="give up?") {

			satuKeduaText.text =" " + satuKeduaScript.Graf [7, 8];
