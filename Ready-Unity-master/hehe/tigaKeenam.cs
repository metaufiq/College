...
public class tigaKeenam : MonoBehaviour {
	...
	void Update () {
		if ((satuKeduaScript.Graf [2, 5] != 0 || satuKeduaScript.Graf [2, 5] != 0)&& kameraScript.menuButtonPlay!="give up?") {

			satuKeduaText.text =" " + satuKeduaScript.Graf [2, 5];
