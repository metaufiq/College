...
public class satuKedelapan : MonoBehaviour {
	...
	void Update () {
		if ((satuKeduaScript.Graf [0, 7] != 0 || satuKeduaScript.Graf [0, 7] != 0)&& kameraScript.menuButtonPlay!="give up?") {

			satuKeduaText.text =" " + satuKeduaScript.Graf [0, 7];
