...
public class empatKeenam : MonoBehaviour {
	...
	void Update () {
		if ((satuKeduaScript.Graf [3, 5] != 0 || satuKeduaScript.Graf [3, 5] != 0)&& kameraScript.menuButtonPlay!="give up?") {

			satuKeduaText.text =" " + satuKeduaScript.Graf [3, 5];
