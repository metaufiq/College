...
public class satuKelima : MonoBehaviour {
	...
	void Update () {
		if ((satuKeduaScript.Graf [0, 4] != 0 || satuKeduaScript.Graf [0, 4] != 0)&& kameraScript.menuButtonPlay!="give up?") {

			satuKeduaText.text =" " + satuKeduaScript.Graf [0, 4];
