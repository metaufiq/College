...
public class enamKetujuh : MonoBehaviour {
	...
	void Update () {
		if ((satuKeduaScript.Graf [5, 6] != 0 || satuKeduaScript.Graf [5, 6] != 0)&& kameraScript.menuButtonPlay!="give up?") {

			satuKeduaText.text =" " + satuKeduaScript.Graf [5, 6];
