...
public class tigaKedelapan : MonoBehaviour {
	...
	void Update () {
		if ((satuKeduaScript.Graf [2, 7] != 0 || satuKeduaScript.Graf [2, 7] != 0)&& kameraScript.menuButtonPlay!="give up?") {

			satuKeduaText.text =" " + satuKeduaScript.Graf [2, 7];
