...
public class duaKetiga : MonoBehaviour {
	...
	void Update () {
		if ((satuKeduaScript.Graf [1, 2] != 0 || satuKeduaScript.Graf [1, 2] != 0)&& kameraScript.menuButtonPlay!="give up?") {

			satuKeduaText.text =" " + satuKeduaScript.Graf [1, 2];
