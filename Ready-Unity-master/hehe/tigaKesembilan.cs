...
public class tigaKesembilan : MonoBehaviour {
	...
	void Update () {
		if ((satuKeduaScript.Graf [2, 8] != 0 || satuKeduaScript.Graf [2, 8] != 0)&& kameraScript.menuButtonPlay!="give up?") {

			satuKeduaText.text =" " + satuKeduaScript.Graf [2, 8];
