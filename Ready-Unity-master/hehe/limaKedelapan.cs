...
public class limaKedelapan : MonoBehaviour {
	...
	void Update () {
		if ((satuKeduaScript.Graf [4, 7] != 0 || satuKeduaScript.Graf [4, 7] != 0)&& kameraScript.menuButtonPlay!="give up?") {

			satuKeduaText.text =" " + satuKeduaScript.Graf [4, 7];
