...
public class satuKeenam : MonoBehaviour {
	...
	void Update () {
		if ((satuKeduaScript.Graf [0, 5] != 0 || satuKeduaScript.Graf [0, 5] != 0)&& kameraScript.menuButtonPlay!="give up?") {

			satuKeduaText.text =" " + satuKeduaScript.Graf [0, 5];
