...
public class enamKesembilan : MonoBehaviour {
	...
	void Update () {
		if ((satuKeduaScript.Graf [5, 8] != 0 || satuKeduaScript.Graf [5, 8] != 0)&& kameraScript.menuButtonPlay!="give up?") {

			satuKeduaText.text =" " + satuKeduaScript.Graf [5, 8];
