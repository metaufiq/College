...
public class empatKesembilan : MonoBehaviour {
	...
	void Update () {
		if ((satuKeduaScript.Graf [3, 8] != 0 || satuKeduaScript.Graf [3,8] != 0)&& kameraScript.menuButtonPlay!="give up?") {

			satuKeduaText.text =" " + satuKeduaScript.Graf [3, 8];
