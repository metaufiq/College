...
public class duaKesembilan : MonoBehaviour {
	...
	void Update () {
		if ((satuKeduaScript.Graf [1, 8] != 0 || satuKeduaScript.Graf [1, 8] != 0)&& kameraScript.menuButtonPlay!="give up?") {

			satuKeduaText.text =" " + satuKeduaScript.Graf [1, 8];
