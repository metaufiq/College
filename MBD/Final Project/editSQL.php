...
<head>
	<title></title>
	<link rel="stylesheet" type="text/css" href="editSQL.css">
</head>
<body>
	<?php
		...
		?>
			...
			<section>
				<form action="" method="post">
					<textarea name="sql" placeholder="write your SQL here.."></textarea>
					<br>
					<br>
					<button>Submit SQL</button>
				</form>
				<p style="color: red;">*it will run your query in the background,so it will not show up your query result</p>
			</section>
			</center>
