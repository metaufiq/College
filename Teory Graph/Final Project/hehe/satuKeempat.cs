...
public class satuKeempat : MonoBehaviour {
	...
	void Update () {
		if ((satuKeduaScript.Graf [0, 3] != 0 || satuKeduaScript.Graf [0, 3] != 0)&& kameraScript.menuButtonPlay!="give up?") {

			satuKeduaText.text =" " + satuKeduaScript.Graf [0, 3];
