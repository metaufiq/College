...
public class empatKedelapan : MonoBehaviour {
	...
	void Update () {
		if ((satuKeduaScript.Graf [3, 7] != 0 || satuKeduaScript.Graf [3, 7] != 0)&& kameraScript.menuButtonPlay!="give up?") {

			satuKeduaText.text =" " + satuKeduaScript.Graf [3, 7];
