...
public class limaKesembilan : MonoBehaviour {
	...
	void Update () {
		if ((satuKeduaScript.Graf [4, 8] != 0 || satuKeduaScript.Graf [4, 8] != 0)&& kameraScript.menuButtonPlay!="give up?") {

			satuKeduaText.text =" " + satuKeduaScript.Graf [4, 8];
