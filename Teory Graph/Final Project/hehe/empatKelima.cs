...
public class empatKelima : MonoBehaviour {
	...
	void Update () {
		if ((satuKeduaScript.Graf [3, 4] != 0 || satuKeduaScript.Graf [3, 4] != 0)&& kameraScript.menuButtonPlay!="give up?") {

			satuKeduaText.text =" " + satuKeduaScript.Graf [3, 4];
