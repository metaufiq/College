...
public class enamKedelapan : MonoBehaviour {
	...
	void Update () {
		if ((satuKeduaScript.Graf [5, 7] != 0 || satuKeduaScript.Graf [5, 7] != 0)&& kameraScript.menuButtonPlay!="give up?") {

			satuKeduaText.text =" " + satuKeduaScript.Graf [5, 7];
