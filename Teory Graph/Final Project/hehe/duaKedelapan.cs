...
public class duaKedelapan : MonoBehaviour {
	...
	void Update () {
		if ((satuKeduaScript.Graf [1, 7] != 0 || satuKeduaScript.Graf [1, 7] != 0) && kameraScript.menuButtonPlay!="give up?") {

			satuKeduaText.text =" " + satuKeduaScript.Graf [1, 7];
