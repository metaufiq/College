...
public class duaKelima : MonoBehaviour {
	...
	void Update () {
		if ((satuKeduaScript.Graf [1, 4] != 0 || satuKeduaScript.Graf [1, 4] != 0)&& kameraScript.menuButtonPlay!="give up?") {

			satuKeduaText.text =" " + satuKeduaScript.Graf [1, 4];
