...
public class limaKeenam : MonoBehaviour {
	...
	void Update () {
		if ((satuKeduaScript.Graf [4, 5] != 0 || satuKeduaScript.Graf [4, 5] != 0)&& kameraScript.menuButtonPlay!="give up?") {

			satuKeduaText.text =" " + satuKeduaScript.Graf [4, 5];
