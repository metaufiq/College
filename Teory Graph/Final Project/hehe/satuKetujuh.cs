...
public class satuKetujuh : MonoBehaviour {
	...
	void Update () {
		if ((satuKeduaScript.Graf [0, 6] != 0 || satuKeduaScript.Graf [0, 6] != 0)&& kameraScript.menuButtonPlay!="give up?") {

			satuKeduaText.text =" " + satuKeduaScript.Graf [0, 6];
